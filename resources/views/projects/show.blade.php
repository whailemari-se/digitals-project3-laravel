...
@section('content')
     ...
     <!-- <a href="/digitals-project3/public/projects/create" class="pull-right btn btn-default btn-sm" >Add Project</a> -->
<br/>
...
<div class="col-sm-3 col-md-3 col-lg-3 pull-right">
          ...
          <div class="sidebar-module">
            ...
            <ol class="list-unstyled">
              <li><a href="/digitals-project3/public/projects/{{ $project->id }}/edit">
              <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
              Edit</a></li>
              <li><a href="/digitals-project3/public/projects/create"><i class="fa fa-plus-circle" aria-hidden="true"></i> Create new project</a></li>
              <li><a href="/digitals-project3/public/projects"><i class="fa fa-user-o" aria-hidden="true"></i> My projects</a></li>
